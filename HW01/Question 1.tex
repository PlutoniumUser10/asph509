...
\[\begin{array}{c@{\hspace*{6em}}c}
    D                   & I                                  \\\hline
    x^2\rnode[br]{A1}{} & exp(2\lambda x)                       \\
    2x\rnode[br]{B1}{}  & \rnode[l]{B2}{}\frac{exp(2\lambda x)}{2\lambda} \\
    2\rnode[br]{C1}{}   & \rnode[l]{C2}{}\frac{exp(2\lambda x)}{4\lambda^2} \\
    0\rnode[br]{D1}{}   & \rnode[l]{D2}{}\frac{exp(2\lambda x)}{8\lambda^3}
\end{array}\]
%%
\ncline[nodesep=1em,arrows=->]{A1}{B2}
\lput{:U}{\rput[c]{U}(0,2ex){+}}
%%
\ncline[nodesep=1em,arrows=->]{B1}{C2}
\lput{:U}{\rput[c]{U}(0,2ex){-}}

\ncline[nodesep=1em,arrows=->]{C1}{D2}
\lput{:U}{\rput[c]{U}(0,2ex){+}}
This computes to 
\begin{equation}
